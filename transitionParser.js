...
"value":function(){var $elf=this,_fromIdx=this.input.idx;return this._or(function(){return this._apply("number");},function(){return this._apply("expression");});},
...
"property":function(){var $elf=this,_fromIdx=this.input.idx,actor,p,a,v;actor=this._apply("anything");p=this._apply("name");a=this._or(function(){a=this._apply("animation");this._applyWithArgs("token","(");v=this._apply("value");this._applyWithArgs("token",")");return ({"a": a,"f": v});},function(){v=this._apply("value");return ({"a": Utils.animationModeFromString("linear"),"f": v});});return this._applyWithArgs("addProperty",actor,p,({"animation": a["a"],"getValue": a["f"]}));},
...
"transition":function(){var $elf=this,_fromIdx=this.input.idx,ret;ret=this._apply("newObject");this._many(function(){return this._applyWithArgs("state",ret);});this._apply("spaces");this._apply("end");return ret;}});(Parser["newObject"]=(function (){return ({});}));(Parser["addProperty"]=(function (o,p,v){(o[p]=v);}));let parse=(function (str){return Parser.matchAll(str,"transition");})
