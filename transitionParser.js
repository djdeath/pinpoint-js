...
const Utils=imports["utils"];let Parser=objectThatDelegatesTo(OMeta,{
"name":function(){var $elf=this,_fromIdx=this.input.idx;this._apply("spaces");return this._consumedBy(function(){this._apply("letter");return this._many(function(){return this._or(function(){return this._apply("letter");},function(){return (function(){switch(this._apply('anything')){case "-":return "-";default: throw fail}}).call(this);});});});},
"number":function(){var $elf=this,_fromIdx=this.input.idx,f;this._apply("spaces");f=this._consumedBy(function(){this._opt(function(){return this._applyWithArgs("exactly","-");});this._many1(function(){return this._apply("digit");});return this._opt(function(){this._applyWithArgs("exactly",".");return this._many1(function(){return this._apply("digit");});});});return parseFloat(f);},
"valueNumber":function(){var $elf=this,_fromIdx=this.input.idx,n;n=this._apply("number");return (function (){return n;});},
"expression":function(){var $elf=this,_fromIdx=this.input.idx,m,n;m=this._or(function(){this._applyWithArgs("token","-");return (- (1));},function(){this._apply("empty");return (1);});this._applyWithArgs("exactly","$");n=this._apply("name");return (function (ctx){return (m * ctx[n]);});},
"value":function(){var $elf=this,_fromIdx=this.input.idx;return this._or(function(){return this._apply("valueNumber");},function(){return this._apply("expression");});},
"animation":function(){var $elf=this,_fromIdx=this.input.idx,a;a=this._apply("name");this._pred(Utils.isAnimationMode(a));return Utils.animationModeFromString(a);},
"property":function(){var $elf=this,_fromIdx=this.input.idx,actor,p,a,v;actor=this._apply("anything");p=this._apply("name");a=this._or(function(){a=this._apply("animation");this._applyWithArgs("token","(");v=this._apply("value");this._applyWithArgs("token",")");return ({"a": a,"f": v});},function(){v=this._apply("value");return ({"a": Utils.animationModeFromString("none"),"f": v});});return this._applyWithArgs("addProperty",actor,p,({"animation": a["a"],"getValue": a["f"]}));},
"actorState":function(){var $elf=this,_fromIdx=this.input.idx,state,n,ret;state=this._apply("anything");n=this._apply("name");this._applyWithArgs("token","->");ret=this._apply("newObject");this._many(function(){return this._applyWithArgs("property",ret);});return this._applyWithArgs("addProperty",state,n,ret);},
"state":function(){var $elf=this,_fromIdx=this.input.idx,transition,n,ret;transition=this._apply("anything");n=this._apply("name");this._applyWithArgs("token","=>");ret=this._apply("newObject");this._many(function(){return this._applyWithArgs("actorState",ret);});return this._applyWithArgs("addProperty",transition,n,ret);},
"duration":function(){var $elf=this,_fromIdx=this.input.idx,transition,p,n;transition=this._apply("anything");p=this._applyWithArgs("token","duration");this._applyWithArgs("token","=");n=this._apply("number");return this._applyWithArgs("addProperty",transition,p,n);},
"transition":function(){var $elf=this,_fromIdx=this.input.idx,ret;ret=this._apply("newObject");this._many(function(){return this._or(function(){return this._applyWithArgs("state",ret);},function(){return this._applyWithArgs("duration",ret);});});this._apply("spaces");this._apply("end");return ret;}});(Parser["newObject"]=(function (){return ({});}));(Parser["addProperty"]=(function (o,p,v){(o[p]=v);}));let parse=(function (str){return Parser.matchAll(str,"transition");})
