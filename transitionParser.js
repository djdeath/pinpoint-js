...
"name":function(){var $elf=this,_fromIdx=this.input.idx;this._apply("spaces");return this._consumedBy(function(){this._apply("letter");return this._many1(function(){return this._or(function(){return this._apply("letter");},function(){return (function(){switch(this._apply('anything')){case "-":return "-";default: throw fail}}).call(this);});});});},
...
"property":function(){var $elf=this,_fromIdx=this.input.idx,actor,p,a,n,v;actor=this._apply("anything");p=this._apply("name");v=this._or(function(){a=this._apply("animation");this._applyWithArgs("token","(");n=this._apply("number");this._applyWithArgs("token",")");return ({"a": a,"n": n});},function(){n=this._apply("number");return ({"a": Utils.animationModeFromString("linear"),"n": n});});return this._applyWithArgs("addProperty",actor,p,({"animation": v["a"],"value": v["n"]}));},
