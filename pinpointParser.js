...
"styleName":function(){var $elf=this,_fromIdx=this.input.idx,n;n=this._many1(function(){this._not(function(){return this._applyWithArgs("exactly","]");});return this._apply("anything");});return n.join("");},
"background":function(){var $elf=this,_fromIdx=this.input.idx,n;return this._or(function(){return (function(){switch(this._apply('anything')){case "camera":return ["background",new Backgrounds.Camera()];default: throw fail}}).call(this);},function(){n=this._apply("styleName");this._pred(Utils.isMimeType(n,"image/"));return ["background",new Backgrounds.Image(n)];},function(){n=this._apply("styleName");this._pred(Utils.isMimeType(n,"video/"));return ["background",new Backgrounds.Video(n)];});},
"styleValue":function(){var $elf=this,_fromIdx=this.input.idx,v;this._applyWithArgs("token","=");v=this._many1(function(){this._not(function(){return this._applyWithArgs("exactly","]");});return this._apply("anything");});return v.join("");},
"style":function(){var $elf=this,_fromIdx=this.input.idx,k,v,c,s;return this._or(function(){k=this._applyWithArgs("token","duration");v=this._apply("styleValue");return [k,parseFloat(v)];},function(){k=this._applyWithArgs("token","text-color");v=this._apply("styleValue");return [k,Utils.colorFromString(v)];},function(){k=this._applyWithArgs("token","text-alignment");v=this._apply("styleValue");return [k,Utils.textAlignment(v)];},function(){c=this._apply("styleName");this._pred(Utils.isValidColor(c));return ["background",new Backgrounds.Color(Utils.colorFromString(c))];},function(){this._apply("spaces");s=this._consumedBy(function(){this._apply("letter");return this._many1(function(){return this._or(function(){return this._apply("letter");},function(){return this._apply("digit");},function(){return (function(){switch(this._apply('anything')){case "-":return "-";default: throw fail}}).call(this);});});});this._pred(Utils.isGravity(s));this._apply("spaces");return ["gravity",Utils.getGravity(s)];},function(){this._apply("spaces");s=this._consumedBy(function(){this._apply("letter");return this._many1(function(){return this._or(function(){return this._apply("letter");},function(){return this._apply("digit");},function(){return (function(){switch(this._apply('anything')){case "-":return "-";default: throw fail}}).call(this);});});});this._pred(Parser.isKeyword(s));this._apply("spaces");return [s,true];},function(){this._apply("spaces");k=this._consumedBy(function(){this._apply("letter");return this._many1(function(){return this._or(function(){return this._apply("letter");},function(){return this._apply("digit");},function(){return (function(){switch(this._apply('anything')){case "-":return "-";default: throw fail}}).call(this);});});});v=this._apply("styleValue");return [k,v];});},
